<template>
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <!-- <div class="panel"> -->
                    <!-- <div class="panel-heading"> -->
                        ...
                        <router-link :to="{ name: 'outlets.add' }" class="btn btn-primary btn-sm">Add data</router-link>
            ...
            <div class="card-body">
                <b-table striped bordered :items="outlets.data" :fields="fields" show-empty>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p v-if="outlets.data">{{ outlets.data.length }} item dari {{ outlets.meta.total }} total data</p>
                    </div>
                    <div class="col-md-6">
